...
public class Conteur {
	...
	public void raconterHistoire(IBataille bataille, Personnage[] listePersonnages1, Personnage[] listePersonnages2) {
		...
		texte.append(bataille.choisirCombattants(listePersonnages1, listePersonnages2));
		texte.append(bataille.preparerCombat(bataille, tupleChoixCombattants.getListePersonnages2()));
